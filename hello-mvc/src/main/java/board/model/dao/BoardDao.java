...
//	 * @return
//	 */
//	public List<Attachment> findAllAttachmentList(Connection conn, Map<String, Object> param) {
//		String sql = prop.getProperty("findAllAttachmentList");
//		PreparedStatement pstmt = null;
//		ResultSet rset = null;
...
//			}
//		} catch (Exception e) {
//			throw new BoardException("첨부파일 포함 게시글 목록 조회 오류", e);
//		} finally {
//			close(rset);
//			close(pstmt);
//		}
